# Session Context
**Created:** 2026-04-14
**Last Session:** 2026-08-24 (**MCP config isolation fixed: reflip's servers were leaking into this project; replaced the shared ag-switch/mcp_config.json system with per-project `.mcp.json` — pushed to `staging` @ `8be373c`.**
