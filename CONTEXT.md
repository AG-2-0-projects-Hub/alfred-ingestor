# Session Context
**Created:** 2026-04-14
**Last Session:** 2026-07-16 (**THE FLIP shipped — `v1.0.0-beta.1` live — + staging moved to Cloud Run; parity probe caught a real prod RLS gap; a Telegram timeout surfaced** — `main` @ **`4aed6206`** (tagged **`v1.0.0-beta.1`**), `staging` @ **`72e2edc`**, prod backend Cloud Run rev **00017**, NEW staging backend **`alfred-backend-staging` rev 00002** + `alfred-scraper-staging` rev 00001.
