...
- [ ] AI assistant for host support — parked; Claude recommended no-go (do FAQ+help@ instead) — needs an explicit founder decision either way
...
- [ ] Restructure `guide.html` into 3 sections mirroring the walkthrough (queued 2026-09-09)
